...
export class Student {
  ...
  static #yemek = "Musakka"; //! static`in özelligi ise class disindan direkt olarak ulasilabiliniyo olmasi.
  constructor(isim: string, nachname: string) {
    //? staticler constructor icinde tanimlanamaz. Class"in hemen altinda tanimlanir.
