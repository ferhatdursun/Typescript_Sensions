...
//! abstract oldugunda bundan sadece türetebiliriz, üretemeyiz!!
...
class Player14 extends Pembe {
    //! class Pembe de ki constructor private oldugu icin burada Pembe classina erisemiyoruz!!!
  constructor() {
    super(10, 10);
  } //! burada ki super Point class´i
}
...
abstract class Point3 {
    constructor(protected x: number, protected y: number) {
        //? Private yaparsak(x veya y´yi) bunlara erisemiyoruz!!! Private´yi istersen constructor icinde istersek hemen üstünde yazabiliriz!!!
...
class Player4 extends Point4 {
    ...
    //!! override create(){
//! pärent class da (Point4) create() diye bir fonksiyon olmadigi icin overridedan dolayi hata aliyoruz. Override bunu kontrol ediyor.
    //! }
}
